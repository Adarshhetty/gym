...
app.post("/chest", async function (req, res) {
    const detail = await Workout.find({ name: 'chest' });
    console.log(detail);
    res.render("exercise", { info: detail });
})
app.post("/quad", async function (req, res) {
    const detail = await Workout.find({ name: 'quad' });
    console.log(detail);
    res.render("exercise", { info: detail });
})
app.post("/abs", async function (req, res) {
    const detail = await Workout.find({ name: 'abs' });
    console.log(detail);
    res.render("exercise", { info: detail });
})
app.post("/back", async function (req, res) {
    const detail = await Workout.find({ name: 'back' });
    console.log(detail);
    res.render("exercise", { info: detail });
})
app.post("/shoulder", async function (req, res) {
    const detail = await Workout.find({ name: 'shoulder' });
    console.log(detail);
    res.render("exercise", { info: detail });
})
app.post("/arm", async function (req, res) {
    const detail = await Workout.find({ name: 'arm' });
    console.log(detail);
